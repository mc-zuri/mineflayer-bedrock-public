...
function inject (bot, options = {}) {
  ...
  for (const name of ['move_player', 'correct_player_move_prediction', 'set_entity_motion', 'update_attributes', 'set_entity_data', 'mob_effect', 'movement_effect', 'update_player_game_type', 'set_player_game_type', 'set_default_game_type']) {
